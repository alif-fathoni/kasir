...
<head>
    ...
    <!--[if lt IE 9]>
      ...
      <link href="<?= base_url('/datatable/jquery.dataTables.min.css') ?>" rel="stylesheet" />
...
<!-- am chart -->
<script src="<?= base_url('') ?>/pages/widget/amchart/amcharts.min.js"></script>
<script src="<?= base_url('') ?>/pages/widget/amchart/serial.min.js"></script>
<!-- Todo js -->
<script type="text/javascript " src="<?= base_url('') ?>/pages/todo/todo.js "></script>
<!-- Custom js -->
<script type="text/javascript" src="<?= base_url('') ?>/pages/dashboard/custom-dashboard.js"></script>
...
<script src="<?= base_url('') ?>/js/demo-12.js"></script>
...
<script type="text/javascript">
    function removeMask(data) {
        ...
        data1 = data.replace(/,/gi, '');
        data2 = parseInt(data1);

        return data2;
    }

    function addMask(harga) {
